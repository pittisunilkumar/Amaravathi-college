                ...
                <div class="slideIn">
                    ...
                    <div class="col-lg-4 col-lg-offset-1 col-md-4 col-md-offset-1 col-sm-12 col-xs-12 no-padding fitxt-center">
                        ...
                        <div class="content">
                            ...
                            <div class="center img-hol-p">
                                <img src="http://localhost/style/uploads/app_image/logo.png" height="60" alt="School">
                            </div>
                            <div class="address">
                                <p></p>
                            </div>			
                    ...
                    <div class="col-lg-6 col-lg-offset-right-1 col-md-6 col-md-offset-right-1 col-sm-12 col-xs-12 no-padding">
                        <div class="sign-area">
                            ...
                            <form action="<?php echo site_url('site/login') ?>" method="post" accept-charset="utf-8">
                                ...
                                <div class="forgot-text">
                                    ...
                                    <div class="">
                                        <a href="<?php echo site_url('site/forgotpassword') ?>">Lose Your Password?</a>
                                    </div>
                                </div>
